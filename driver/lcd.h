...
//////////////////////////////////////////////////////////////////////////////////	 
//-----------------LCD背光端口定义---------------- 
#define	LCD_BACK PDout(13)  //LCD背光    	PF10 	    


//使用NOR/SRAM的 Bank1.sector4,地址位HADDR[27,26]=11 
//A12作为数据命令区分线 
//注意设置时STM32内部会右移一位对其		    
#define  CMD_BASE        ((u32)(0x60000000) )   //   by ycnalin
#define  DATA_BASE       ((u32)(0x60020000))  //FSMC_A16 ~ PD7  by ycnalin。  范围：0x60000000~0x6FFFFFFF
